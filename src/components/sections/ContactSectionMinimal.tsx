      ...
      <div className="max-w-4xl w-full text-center">
        <div className="mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-100 mb-6">
            <FadeInText text="Let's Build Something Amazing" delay={200} />
          </h2>
          <FadeInText
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="p-8 text-left border border-slate-800/50 rounded-lg bg-slate-950/40 backdrop-blur-sm hover:border-slate-700/70 transition-all">
            <div className="flex items-center gap-3 mb-4">
              <div className="h-12 w-12 rounded-xl border border-slate-700/60 bg-slate-900/60 flex items-center justify-center">
            ...
            <a
              ...
              className="text-slate-300 hover:text-slate-100 transition-colors text-sm font-mono break-all"
            >
              {siteConfig.email}
            </a>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href={`mailto:${siteConfig.email}`}
            className="inline-flex items-center gap-2 rounded-full border border-slate-700/60 bg-slate-900/60 px-8 py-3 text-base font-medium text-slate-100 transition-all hover:border-slate-600/70 hover:bg-slate-800/60"
          >
